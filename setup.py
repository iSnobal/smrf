...
extensions += [
    Extension(
        ...
        sources=[
            os.path.join("smrf/spatial/dk", source_file)
            for source_file in [
...
extensions += [
    Extension(
        ...
        sources=[
            os.path.join("smrf/envphys/core", val)
            for val in ["envphys_c.pyx", "topotherm.c", "dewpt.c", "iwbt.c"]
        ],
        **extension_params,
    ),
    Extension(
    ...
    Extension(
        ...
        sources=[
            os.path.join("smrf/utils/wind", val)
            for val in ["wind_c.pyx", "breshen.c", "calc_wind.c"]
        ],
        **extension_params,
    ),
]
