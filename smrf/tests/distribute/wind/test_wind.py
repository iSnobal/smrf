...
class TestWind(unittest.TestCase):
    ...
    def test_interp_init(self):
        ...
        self.assertTrue(Wind.INTERP, wind_instance.wind_model)
        self.assertTrue(wind_instance.model_type(Wind.INTERP))
    ...
    def test_wind_ninja_init(self, mock_model):
        ...
        self.assertIsInstance(wind_instance.wind_model, WindNinjaModel)
        self.assertTrue(wind_instance.model_type(WindNinjaModel.MODEL_TYPE))
    ...
    def test_winstral_init(self, mock_model):
        ...
        self.assertTrue(mock_model.called)
        self.assertIsInstance(wind_instance.wind_model, WinstralWindModel)
        self.assertTrue(wind_instance.model_type(WinstralWindModel.MODEL_TYPE))
