...
double satw(double tk) {
    ...
    x = -7.90298 * (BOIL / tk - 1.) + 5.02808 * log10(BOIL / tk)
        - 1.3816e-7 * (pow(1.e1, 1.1344e1 * (1. - tk / BOIL)) - 1.)
        + 8.1328e-3 * (pow(1.e1, -3.49149 * (BOIL / tk - 1.)) - 1.) + log10(SEA_LEVEL);
...
double sati(double tk) {
    ...
    x = pow(
        1.e1,
        -9.09718 * ((FREEZE / tk) - 1.) - 3.56654 * log10(FREEZE / tk)
            + 8.76793e-1 * (1. - (tk / FREEZE)) + log10(6.1071)
    );
